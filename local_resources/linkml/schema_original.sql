...
CREATE TABLE "InformationContentEntity" (
	...
	type TEXT NOT NULL, 
	PRIMARY KEY (id)
);COMMENT ON TABLE "InformationContentEntity" IS 'A piece of information that is represented in the typically describes some topic of discourse or is used as support.';COMMENT ON COLUMN "InformationContentEntity".creation_date IS 'date on which an entity was created. This can be applied to nodes or edges';COMMENT ON COLUMN "InformationContentEntity".content IS 'The content of an InformationContentEntity expressed as a string.';COMMENT ON COLUMN "InformationContentEntity".token_count IS 'The number of tokens in the content of an InformationContentEntity.';COMMENT ON COLUMN "InformationContentEntity".embedding IS 'The embedding of an InformationContentEntity.  This is typically a vector representation of the content.';COMMENT ON COLUMN "InformationContentEntity".format IS 'The format (JSON, XML, BINARY) of the content of an InformationContentEntity.';COMMENT ON COLUMN "InformationContentEntity".name IS 'A human-readable name for an attribute or entity.';COMMENT ON COLUMN "InformationContentEntity".id IS 'A simple, locally-generated unique identifier specific with different heuristic formatting for each application.';COMMENT ON COLUMN "InformationContentEntity".type IS 'The type of an Entity expressed as curi.';
...
CREATE TABLE "Note" (
	...
	id TEXT NOT NULL, 
	PRIMARY KEY (id)
);COMMENT ON TABLE "Note" IS 'A structured piece of information with an author that is about another InformationContentEntity.';COMMENT ON COLUMN "Note".format IS 'The format (JSON, XML, BINARY) of the content of an InformationContentEntity.';COMMENT ON COLUMN "Note".type IS 'The type of an Entity expressed as curi.';COMMENT ON COLUMN "Note".creation_date IS 'date on which an entity was created. This can be applied to nodes or edges';COMMENT ON COLUMN "Note".content IS 'The content of an InformationContentEntity expressed as a string.';COMMENT ON COLUMN "Note".token_count IS 'The number of tokens in the content of an InformationContentEntity.';COMMENT ON COLUMN "Note".embedding IS 'The embedding of an InformationContentEntity.  This is typically a vector representation of the content.';COMMENT ON COLUMN "Note".name IS 'A human-readable name for an attribute or entity.';COMMENT ON COLUMN "Note".id IS 'A simple, locally-generated unique identifier specific with different heuristic formatting for each application.';
CREATE TABLE "Author" (
	creation_date DATE, 
	content TEXT, 
	token_count INTEGER, 
	...
	type TEXT NOT NULL, 
	PRIMARY KEY (id)
);COMMENT ON TABLE "Author" IS 'None';COMMENT ON COLUMN "Author".creation_date IS 'date on which an entity was created. This can be applied to nodes or edges';COMMENT ON COLUMN "Author".content IS 'The content of an InformationContentEntity expressed as a string.';COMMENT ON COLUMN "Author".token_count IS 'The number of tokens in the content of an InformationContentEntity.';COMMENT ON COLUMN "Author".embedding IS 'The embedding of an InformationContentEntity.  This is typically a vector representation of the content.';COMMENT ON COLUMN "Author".format IS 'The format (JSON, XML, BINARY) of the content of an InformationContentEntity.';COMMENT ON COLUMN "Author".name IS 'A human-readable name for an attribute or entity.';COMMENT ON COLUMN "Author".id IS 'A simple, locally-generated unique identifier specific with different heuristic formatting for each application.';COMMENT ON COLUMN "Author".type IS 'The type of an Entity expressed as curi.';
CREATE TABLE "Organization" (
	...
	type TEXT NOT NULL, 
	PRIMARY KEY (id)
);COMMENT ON TABLE "Organization" IS 'None';COMMENT ON COLUMN "Organization".creation_date IS 'date on which an entity was created. This can be applied to nodes or edges';COMMENT ON COLUMN "Organization".content IS 'The content of an InformationContentEntity expressed as a string.';COMMENT ON COLUMN "Organization".token_count IS 'The number of tokens in the content of an InformationContentEntity.';COMMENT ON COLUMN "Organization".embedding IS 'The embedding of an InformationContentEntity.  This is typically a vector representation of the content.';COMMENT ON COLUMN "Organization".format IS 'The format (JSON, XML, BINARY) of the content of an InformationContentEntity.';COMMENT ON COLUMN "Organization".name IS 'A human-readable name for an attribute or entity.';COMMENT ON COLUMN "Organization".id IS 'A simple, locally-generated unique identifier specific with different heuristic formatting for each application.';COMMENT ON COLUMN "Organization".type IS 'The type of an Entity expressed as curi.';
CREATE TABLE "City" (
	name TEXT, 
	id TEXT NOT NULL, 
	type TEXT NOT NULL, 
...
CREATE TABLE "ScientificKnowledgeItem" (
	...
	type TEXT NOT NULL, 
	PRIMARY KEY (id)
);COMMENT ON TABLE "ScientificKnowledgeItem" IS 'A specific instance of a ScientificKnowledgeExpression:- our internal representation of an EPMC citation record, a local copy of a full-text article. This is the substrate that forms the basis for a ScientificKnowledgeFragment.';COMMENT ON COLUMN "ScientificKnowledgeItem".representation_of IS 'The ScientificKnowledgeExpression that this ScientificKnowledgeItem  is a representation of.';COMMENT ON COLUMN "ScientificKnowledgeItem".creation_date IS 'date on which an entity was created. This can be applied to nodes or edges';COMMENT ON COLUMN "ScientificKnowledgeItem".content IS 'The content of an InformationContentEntity expressed as a string.';COMMENT ON COLUMN "ScientificKnowledgeItem".token_count IS 'The number of tokens in the content of an InformationContentEntity.';COMMENT ON COLUMN "ScientificKnowledgeItem".embedding IS 'The embedding of an InformationContentEntity.  This is typically a vector representation of the content.';COMMENT ON COLUMN "ScientificKnowledgeItem".format IS 'The format (JSON, XML, BINARY) of the content of an InformationContentEntity.';COMMENT ON COLUMN "ScientificKnowledgeItem".name IS 'A human-readable name for an attribute or entity.';COMMENT ON COLUMN "ScientificKnowledgeItem".id IS 'A simple, locally-generated unique identifier specific with different heuristic formatting for each application.';COMMENT ON COLUMN "ScientificKnowledgeItem".type IS 'The type of an Entity expressed as curi.';
