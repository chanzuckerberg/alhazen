...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'alhazen.apps': {'alhazen.apps.single_paper_chatbot': ('apps.html#single_paper_chatbot', 'alhazen/apps.py')},
            'alhazen.backend': { 'alhazen.backend.count_papers': ('client.html#count_papers', 'alhazen/backend.py'),
                                 'alhazen.backend.list_corpora': ('client.html#list_corpora', 'alhazen/backend.py')},
            ...
            'alhazen.utils.db': { 'alhazen.utils.db.LocalLiteratureDb': ('localdb.html#localliteraturedb', 'alhazen/utils/db.py'),
                                  ...
                                  'alhazen.utils.db.get_nxml_from_pubmed_doi': ( 'localdb.html#get_nxml_from_pubmed_doi',
                                                                                 'alhazen/utils/db.py'),
                                  'alhazen.utils.db.get_nxml_from_scipubstore_doi': ( 'localdb.html#get_nxml_from_scipubstore_doi',
                                                                                      'alhazen/utils/db.py')},
