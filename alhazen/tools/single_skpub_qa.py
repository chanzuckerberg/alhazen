# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/11_single_document_qa copy.ipynb.

# %% auto 0
__all__ = ['PROMPT_SINGLE_ARTICLE_QUESTION', 'LocalFileLangChainChatBot']

# %% ../../nbs/11_single_document_qa copy.ipynb 2
import os
import pandas as pd
...
# %% ../../nbs/11_single_document_qa copy.ipynb 3
