...
# %% auto 0
__all__ = ['IR', 'SKC', 'SKC_PROV', 'SKC_HM', 'SKE', 'SKE_XREF', 'SKE_IRI', 'SKE_HR', 'SKE_MO', 'SKI', 'SKI_HP', 'SKF', 'N',
           'SKC_HN', 'SKE_HN', 'SKI_HN', 'SKF_HN', 'create_ceifns_database', 'drop_ceifns_database',
           'backup_ceifns_database', 'restore_ceifns_database', 'Ceifns_LiteratureDb',
